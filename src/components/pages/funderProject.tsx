...
const ProjectList = () => {
  ...
  console.log(cookies.get('ngoId'));
   useEffect(() => {
        async function fetchData() {
          let {data} = await axios.post(`http://ec2-18-224-65-21.us-east-2.compute.amazonaws.com:8080/ngo/getProjects`, {funderId: cookies.get('ngoId'), type: 'funder'})
          setListData(data);
        }    
        fetchData()
      }, [])
